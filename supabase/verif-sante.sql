-- ============================================================================
-- CONTRÔLE DE SANTÉ COMPLET — à coller dans l'éditeur SQL de Supabase.
--
-- Ne modifie RIEN : que des lectures. Une ligne par contrôle, avec un verdict.
-- Règle de lecture : chercher « PROBLÈME ». S'il n'y en a aucun, tout est en ordre.
--
-- Écrit après l'incident du 01/08 (perte des privilèges de table du rôle
-- authenticated). Sert aussi de DOCUMENTATION EXÉCUTABLE du modèle attendu :
-- droits, RLS, fonctions verrouillées, déclencheurs, tâches planifiées, secrets.
-- ============================================================================
